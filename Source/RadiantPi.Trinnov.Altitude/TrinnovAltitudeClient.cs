...
public sealed class TrinnovAltitudeClient : ITrinnovAltitude {
    ...
    public Task SelectPresetAsync(TrinnovAltitudePreset preset) => _telnet.SendAsync($"loadp {(int)preset}");
    public Task SelectProfileAsync(TrinnovAltitudeProfile source) => _telnet.SendAsync($"profile {(int)source}");
